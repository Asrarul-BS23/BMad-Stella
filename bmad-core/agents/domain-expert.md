...
commands:
  ...
  - reload: Re-fetch all domain knowledge pages fresh from Confluence using Atlassian MCP — finds the Domain-Knowledge child page under architectureFolderUrl and re-fetches all its children (use when Confluence documentation has been updated). WARNING - this will delete and replace the existing bmad-docs/domain-knowledge/ folder
